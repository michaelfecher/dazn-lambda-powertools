...
Lambda client wrapper that knows how to forward correlation IDs (captured via `@michaelfecher/lambda-powertools-correlation-ids`).
...
Install from NPM: `npm install @michaelfecher/lambda-powertools-lambda-client`
...
```js
const Lambda = require('@michaelfecher/lambda-powertools-lambda-client')
