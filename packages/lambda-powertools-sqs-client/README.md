...
SQS client wrapper that knows how to forward correlation IDs (captured via `@michaelfecher/lambda-powertools-correlation-ids`).
...
Install from NPM: `npm install @michaelfecher/lambda-powertools-sqs-client`
...
```js
const SQS = require('@michaelfecher/lambda-powertools-sqs-client')
